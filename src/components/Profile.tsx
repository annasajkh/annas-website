...
export default function Profile() {
    return (
        <div className="profile">
            ...
            <p className="quote">"The entire universe is the emergent properties of rules, we tried to discover and make sense of the rules using multiple level of abstractions, we use math to map the rules to things we can calculate, but not all rules can be mapped to math, but it doesn't stop us for making sense of the rules, down from the quantum level using quantum mechanics up to human intelligence and human behaviors using psychology, social systems, and neuroscience, and galaxies using general relativity, special relativity, thermodynamics, and entropy, i said this before i was going to celebrate Isra' and Mi'raj on my religion that i was born into that is islam on my local mosque"</p>
        </div>
    );
}
