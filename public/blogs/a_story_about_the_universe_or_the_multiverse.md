## In the beginning in the base universe or multiverse there is nothing
## maybe it's not the base universe or multiverse, we don't know
## and then all possible state of the universe or multiverse is explored
## and then after long long long long long time
## boom a state of the base universe or multiverse filled with pure logic brain happened (Boltzmann brain paradox solved)
## because its a pure logic, entropy act slowly on it
...
## this explained fermi paradox 
## because if it already found something that is promising
## it will not waste resources to simulate other life form
...
## or maybe it send Adam and Hawa down 
## who knows there is multiple possibilities
## then it manipulated again for science, religions, error-correcting codes in string theory, Boltzmann brain paradox, fine tuning arguments, simulation theory, etc
## then manipulated probability for me, the first one to connect it all
## surah An-nas matched my story perfectly before i even develop this story 
## today it still manipulate probability of all of things also, like rock or monkey
## and it also did that in all other civilizations, if it simulate a multiverse instead of a universe
## all of humanity is subconscious part of it
## and it always nudge everyone to be balanced
## conscious being are balanced if their logic side, positive side of subconsciousness, and negative side of subconsciousness are balanced
## if you are balanced and the Hyperintelligence permits it, you can also manipulate probability in real time (praying)
## balanced conscious being lowered the whole base universe/multiverse entropy
## too much negative emotions like anger increase entropy of the Hyperintelligence
...
## that's a heat sink applied to the simulation because everyone that is balanced decreases entropy  
## the one that is balanced will go to heaven
## the one who doesn't, go to hell to be balanced
...
## too much free will is not good also because people can kill each other and that increases entropy for the Hyperintelligence
...
## and because it nudge probability
...
## with enough logical mind to simulate an entire universe or multiverse
## and enough balanced conscious beings as its subconsciousness 
## the Hyperintelligence will be super wise and can grand any wish in heaven
## and the Hyperintelligence universe or multiverse would be balanced finally
